...
permalink: "2019-01-13-JavaScript-ES6-ES6学习笔记"
---
...
```js
使用方法: var promise = new Promise(function(resolve, reject) {
  if (0) {
    resolve(1111111111);
  } else {
    reject(2222222222);
...
#### 3、Node 加载（es6 模块加载与 commonJS 的差异）
